...
AFA_DEVICE_CONSTEXPR int swizzled_col_fragment(int row, int col_fragment) {
...
AFA_DEVICE_CONSTEXPR int get_smem_col_fragment(const int row,
...
AFA_DEVICE_CONSTEXPR int get_smem_offset(const int row, const int col) {
